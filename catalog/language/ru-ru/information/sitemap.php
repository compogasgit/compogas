...
$_['meta_title']       = 'Карта сайта compogas.ru';
$_['meta_description'] = 'Для быстрого перехода по страницам compogas.ru предлагаем воспользоваться картой сайта.';
$_['meta_keywords']    = 'Карта сайта';
